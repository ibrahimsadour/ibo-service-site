                                ...
                                <li class="widget-single-post-item widget-post-list tie-standard">
                                    <div class="post-widget-thumbnail">
                                        <a
                                            aria-label="{{$section
                                             -> name}}"
                                            href="{{ URL::route('section.index',$section
                                             -> slug) }}" title="{{ $section
                                             -> name}}"
                                            class="post-thumb"
                                        ><span class="post-cat-wrap"><span class="post-cat tie-cat-8">{{$section
                                         ->name}}</span></span>
                                            <img
                                                width="220"
                                                height="150"
                                    ...
                                    <div class="post-widget-body">
                                        <a class="post-title the-subtitle" href="{{ URL::route('section.index',$section
                                         -> slug) }}" title="{{ $section
                                         -> name}}">الخدمات الخاصة بقسم {{$section
                                         ->name}}</a>
                                        <br>
                                        <a
                                        class="more-link button"
                                        href="{{ URL::route('section.index',$section
                                         -> slug) }}" title="{{$section->name}}">أكمل القراءة »
                                    </a>
                                    </div>
                                    <div class="post-meta">
                                        <span class="date meta-item tie-icon">{{$section
